...
public class ImageFileLoader {
    ...
    public ImageFileLoader(Context context, boolean isFolder,
    ...
    private class ImageLoadRunnable {
        ...
        public void get() {
            ...
            if (cursor == null) {
                mImageLoaderListener.onFailure(new NullPointerException());
                return;
            }
            ...
            mImageLoaderListener.onLoaded(Observable.just(result));
        }
    }
